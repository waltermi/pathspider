...
INTERMEDIATE_SENTINEL = "INTERMEDIATE_SENTINEL"
NO_FLOW = None
...
class Spider:
    ...
    def merger(self):
        ...
        """Measure workflow has finished, now only the traceroute packets have to be merged"""
        if self.args.trace:
            while True:
                try:
                    flow = self.flowqueue.get_nowait()
